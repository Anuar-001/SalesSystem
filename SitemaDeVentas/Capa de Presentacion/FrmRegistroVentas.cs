    ...
    public partial class FrmRegistroVentas : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            if(this.txtDocIdentidad.Text.Trim()!=""){
                        ...
                        if (Convert.ToInt32(txtCantidad.Text) >= 0){
                            if (Convert.ToInt32(txtCantidad.Text) <= Convert.ToInt32(txtStock.Text)){
                                if (txtIgv.Text.Trim() != ""){
                                    ...
                                    MessageBox.Show("Por Favor Ingrese I.G.V.","Sistema de Ventas.",MessageBoxButtons.OK,MessageBoxIcon.Error);
                                    txtIgv.Focus();
                                }
                            }else{
                ...
                MessageBox.Show("Por Favor Busque el Cliente a Vender.", "Sistema de Ventas", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1);
            }
        }
