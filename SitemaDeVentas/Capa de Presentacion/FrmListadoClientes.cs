...
namespace Capa_de_Presentacion
{
    public partial class FrmListadoClientes : Form
    {
        ...
        {
            if(MessageBox.Show("¿Está Seguro que Desea Sair.?", "Sistema de Ventas.", MessageBoxButtons.YesNo,MessageBoxIcon.Error) == DialogResult.Yes)
            {
                Close();
            }
        }
        ...
        private void dataGridView1_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0) {
                if (e.KeyChar == 13){
                    ...
                    Resultado = MessageBox.Show("Está Seguro que Desea Editar Los Datos del Cliente.", "Sistema de Ventas.", MessageBoxButtons.YesNo, MessageBoxIcon.Error);
